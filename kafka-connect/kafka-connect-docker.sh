...
export KAFKA_CONNECT_KEY_CONVERTER=${KAFKA_CONNECT_KEY_CONVERTER:-org.apache.kafka.connect.json.JsonConverter}
export KAFKA_CONNECT_VALUE_CONVERTER=${KAFKA_CONNECT_VALUE_CONVERTER:-org.apache.kafka.connect.json.JsonConverter}
...
# /bin/gosu "${CONFLUENT_USER}:${CONFLUENT_GROUP}"
/usr/bin/connect-distributed "${kc_cfg_file}" "$@"
